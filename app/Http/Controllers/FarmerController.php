...
class FarmerController extends Controller
{
    ...
    public function getFarmer()
    {
        ...
        $total_space = 0;
        $block_timestamp = Partial::where('launcher_id', '2d2fe94bc590f4f96289fac3a4ab9f80ac15deb9489272ab84a28a45294d8d2b')->where('difficulty', '<', 3)->orderBy('timestamp', 'DESC')->first();
